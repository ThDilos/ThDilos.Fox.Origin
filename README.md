...
You are not viewing the main branch, but a branch for **1.19-1.19.3**

In this lower version, some functionalities are forgone because Origin / Minecraft does not support them here.

Functions that are **different** from the Main version (1.19.4-1.20.4) are:
1. EXTRA STRIKE **cannot** bypass cooldown, armor, effects. So it is Delayed from 4 ticks to 10 ticks.
2. Wolf and Polar Bear **won't** deal EXTRA STRIKE to you because of the same reason. They deal 200% damage to you instead.
